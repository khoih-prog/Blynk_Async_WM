...
#define BLYNK_ASYNC_WM_VERSION      "v1.1.0_ESP32"
...
// -- HTML page fragments
const char BLYNK_WM_HTML_HEAD[]     /*PROGMEM*/ = "<!DOCTYPE html><html><head><title>BlynkSimpleEsp32_Async_WM</title><style>div,input{padding:2px;font-size:1em;}input{width:95%;}\
