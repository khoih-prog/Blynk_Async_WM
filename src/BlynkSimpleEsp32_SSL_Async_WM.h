...
#define BLYNK_ASYNC_WM_VERSION      "Blynk_Async_WM SSL for ESP32 v1.6.2"
...
// But if not specified any, use SPIFFS to not forcing user to install LITTLEFS library
  ...
  #warning Using LittleFS in BlynkSimpleESP32_SSL_Async_WM.h
#elif USE_SPIFFS
  #include "FS.h"
  #include <SPIFFS.h>
  FS* filesystem =      &SPIFFS;
  #define FileFS        SPIFFS
  #warning Using SPIFFS in BlynkSimpleESP32_SSL_Async_WM.h
#else
  #include <EEPROM.h>
  #warning Using EEPROM in BlynkSimpleESP32_SSL_Async_WM.h
#endif
...
const char BLYNK_WM_HTML_HEAD_START[] /*PROGMEM*/ = "<!DOCTYPE html><html><head><title>BlynkSimpleEsp32_SSL_Async_WM</title>";
